...
class PlayerTest {
    ...
    void penalty() {
        ...
        player.penalty();
        assertTrue(expectedScore - player.score() == 0, "The score did not change");
    }

    @Test
    void setFlag() {
        int expectedFlag = 2;
        player.setFlag(expectedFlag);
        assertTrue(expectedFlag - player.getFlag() == 0, "The flag changed to the value we gave him");
    }
}